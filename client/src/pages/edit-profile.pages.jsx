        ...
        <AnimationWrapper>
            {
                ...
                <form ref={editProfileForm} >
                    <Toaster />
                    <h1 className="max-md:hidden text-blue-gwen">Edit profile</h1>
                    <div className="flex flex-col lg:flex-row items-start py-10 gap-8 lg:gap-10">
                        <div className="max-lg:center mb-5">
                            ...
                            <button className="btn-blue-gwen mt-5 max-lg:center lg:w-full px-10" onClick={handleImageUpload}>Upload</button>

                            <input type="file" id="uploadImg" accept=".jpeg, .png, .jpg" hidden onChange={handleImagePreview} />
                        </div>
                        <div className="w-full">
                            <div className="grid gird-cols-1 md:grid-cols-2 md:gap-5">
                                <div>
                            ...
                            <p className="text-blue-gwen -mt-3">Username will use to search user and will be visible to all users</p>
                            ...
                            <p className="text-blue-gwen mt-1">{charactersleft} Characters left</p>

                            <p className="my-6 text-blue-gwen">Add your social handles below</p>
                            ...
                            <div className="w-full flex justify-center  md:justify-start">
                                <button className="btn-blue-gwen w-auto px-10" type="submit" onClick={handleSubmit}>Update</button>
                            </div>
                        </div>
                    </div>
                </form>
