    ...
    return(
        <AnimationWrapper>
            ...
            <form ref={changePasswordForm}>
                <h1 className="max-md:hidden text-blue-gwen ">Change Password</h1>

                <div className="py-10 w-full md:max-w-[400px] h-auto">
                    ...
                    <div className="w-full flex justify-center mt-10 md:mt-5 md:justify-start">
                    <button className="btn-blue-gwen  px-10" type="submit" onClick={handleSubmit}>Change Password</button>
                    </div>
                </div>
            </form>
        </AnimationWrapper>
