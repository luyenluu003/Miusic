...
const MenuHome = () => {
    ...
    <div className=" fixed">
        <div className="max-w-[10%] flex flex-col space-y-10">
            ...
            <Link to={"user/:id"} className="flex w-full mt-5 cursor-pointer  ">
            ...
            <Link to={"/rules"} className="flex w-full mt-5 cursor-pointer  ">
                ...
                <p className="font-normal text-xl ml-10 text-center my-auto leading-6 text-[#3D3B4A] focus:text-[#3F95D7] hover:text-[#3F95D7]">Support</p>
            </Link>
        </div>
    </div>
</div>
